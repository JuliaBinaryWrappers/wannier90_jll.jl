# Autogenerated wrapper script for wannier90_jll for x86_64-apple-darwin-libgfortran5
export libwannier, wannier90

using OpenBLAS32_jll
using CompilerSupportLibraries_jll
JLLWrappers.@generate_wrapper_header("wannier90")
JLLWrappers.@declare_library_product(libwannier, "@rpath/libwannier.dylib")
